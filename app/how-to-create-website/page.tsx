...
export const metadata: Metadata = {
  ...
  description: 'Подробная инструкция: как создать сайт самостоятельно или заказать у профессионала. Сравнение конструкторов и чистого кода, советы по выбору решения для вашего бизнеса.',
