          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8 animate-in">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-xl leading-relaxed">
                ...
                трафик, улучшаем позиции в поисковой выдаче и помогаем привлекать клиентов без <Link href="/website-advertising" className="text-primary-300 hover:underline font-semibold">рекламы</Link>.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  ...
                  <p className="text-sm text-white/70">Рост трафика</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-white mb-1">Топ-10</div>
                  <p className="text-sm text-white/70">Позиции в Google</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-white mb-1">3-6 мес</div>
                  <p className="text-sm text-white/70">Срок результата</p>
                </div>
              </div>
            </div>
