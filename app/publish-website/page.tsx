...
export const metadata: Metadata = {
  ...
  description: 'Пошаговая инструкция: как опубликовать сайт в интернете, добавить в Google и Яндекс, настроить домен и хостинг. Помощь в публикации сайта в Алматы.',
