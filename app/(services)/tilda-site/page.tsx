...
const faqItems = [
  {
    ...
    answer: 'Tilda — визуальный конструктор сайтов с готовыми блоками. Выбирают за простоту редактирования, современный дизайн и возможность вносить изменения без программиста. Идеально для малого бизнеса и стартапов.',
  },
  {
    id: '2',
    question: 'Сколько стоит сайт на Tilda?',
    answer: 'Стоимость разработки сайта на Tilda — от 120 000₸. Цена зависит от количества страниц, сложности дизайна и функционала. В стоимость входит настройка блоков, адаптация под мобильные и базовая SEO-оптимизация.',
  },
  {
    id: '3',
    question: 'Могу ли я сам редактировать сайт на Tilda?',
    answer: 'Да, это главное преимущество Tilda. После создания сайта получите доступ к админке и сможете редактировать тексты, менять изображения, добавлять блоки. Проводим обучение по работе с редактором.',
  },
  {
    id: '4',
    question: 'Сколько времени занимает создание сайта на Tilda?',
    answer: 'Простой сайт на 1-3 страницы — 2-3 дня. Сложные проекты с множеством страниц и интеграциями — 5-7 дней. Tilda позволяет работать быстрее благодаря готовым блокам.',
  },
  {
    id: '5',
    question: 'Можно ли сделать интернет-магазин на Tilda?',
    answer: 'Да. Tilda имеет встроенный функционал для интернет-магазинов: каталог товаров, корзина, оформление заказа, интеграция с платёжными системами. Для магазинов до 100-200 товаров — отличное решение.',
  },
  {
    id: '6',
    question: 'Нужно ли платить за подписку Tilda?',
    answer: 'Да, для работы сайта нужна подписка Tilda. Тариф Personal — около 15 000₸/год, подходит для большинства проектов. Тариф Business для интернет-магазинов — около 25 000₸/год. Поможем выбрать оптимальный тариф.',
  },
  {
    id: '7',
    question: 'Чем Tilda отличается от обычного сайта?',
    answer: 'Сайт на Tilda использует готовые блоки конструктора — разработка быстрее и дешевле. Обычный сайт разрабатывается с нуля, даёт больше свободы в дизайне, но дороже. Для SEO-продвижения обычный сайт предпочтительнее.',
  },
]
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {tildaBlocks.map((block, index) => (
              <div key={block.name} className="group relative overflow-hidden rounded-2xl aspect-[4/3] bg-secondary-100 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <Image
                  src={block.image}
                  alt={block.alt}
                  fill
              ...
              >
                ...
                <ul className="space-y-3 mb-8">
                  {type.features.map((feature, idx) => (
                    <li key={`${type.title}-feature-${feature}`} className="flex items-start gap-2 text-secondary-600 dark:text-secondary-300">
