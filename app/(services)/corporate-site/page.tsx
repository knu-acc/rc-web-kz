...
export const metadata: Metadata = {
  ...
  description: 'Профессиональная разработка корпоративных и многостраничных сайтов в Алматы. Идеально для SEO-продвижения и рекламы компании. Современный дизайн, полный функционал. Цена 135-195 тыс тенге.',
  keywords: [
...
const processSteps = [
  {
    ...
    description: 'Обсуждаем цели сайта, количество страниц, функционал и ваши предпочтения в дизайне. Формируем техническое задание.',
  },
  {
    step: 2,
    title: 'Готовый макет сайта',
    description: 'Создаём уникальный дизайн макета, согласовываем с вами, затем приступаем к вёрстке и программированию всех страниц.',
  },
  {
    step: 3,
    title: 'Создание сайта',
    description: 'Разрабатываем все страницы, настраиваем формы, интегрируем необходимые сервисы. Каждый этап показываем вам.',
  },
  {
    step: 4,
    title: 'Запуск и поддержка',
    description: 'Публикуем сайт в интернете, настраиваем аналитику, проводим обучение работе с сайтом и обеспечиваем техническую поддержку.',
  },
]
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-secondary-600">
              Выберите подходящий тип сайта для вашей компании. Каждый вариант решает свои задачи.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-secondary-700">3-10+ страниц с уникальным контентом</p>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <p className="text-secondary-700">Оптимизация для поисковых систем (SEO)</p>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <p className="text-secondary-700">Админ-панель для управления контентом</p>
                </div>
              </div>
            </div>
      ...
      <section className="section bg-secondary-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-secondary-600">Пошаговый процесс от идеи до запуска</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-secondary-50 rounded-2xl shadow-lg border border-secondary-300 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-secondary-900">Входит в стоимость:</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-secondary-900">Сроки:</h3>
                <ul className="space-y-2 text-secondary-700">
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600">✓</span>
