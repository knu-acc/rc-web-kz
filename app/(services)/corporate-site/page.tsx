        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {siteTypes.map((type, index) => (
              <div key={index} className="group relative overflow-hidden rounded-2xl bg-white dark:bg-secondary-900 border border-secondary-300 dark:border-secondary-600 hover:border-primary-300 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
