        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {galleryImages.map((img, index) => (
              <div key={index} className={`group relative overflow-hidden rounded-2xl aspect-[4/3] bg-secondary-100 dark:bg-secondary-800 ${index === 0 ? 'md:col-span-2 lg:col-span-2' : ''}`}>
                <Image
                  src={img.src}
                  alt={img.alt}
                  fill
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {paymentSystems.map((system, index) => (
              <div key={index} className="flex flex-col items-center justify-center p-6 bg-secondary-50 dark:bg-secondary-800 rounded-2xl hover:shadow-md transition-shadow">
