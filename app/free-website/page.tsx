...
export const metadata: Metadata = {
  ...
  description: 'Как создать сайт бесплатно: обзор бесплатных конструкторов, хостингов и инструментов. Плюсы и минусы бесплатных решений, когда стоит заказать сайт у профессионала.',
