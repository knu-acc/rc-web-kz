          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8 animate-in">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-xl leading-relaxed">
                ...
                Современные тренды, удобный интерфейс, адаптивность для всех устройств. Посмотрите наши работы в <Link href="/portfolio" className="text-primary-300 hover:underline font-semibold">портфолио</Link>.
              </p>
