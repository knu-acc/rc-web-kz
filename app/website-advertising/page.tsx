          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8 animate-in">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-xl leading-relaxed">
                ...
                привлечение клиентов, оптимизация бюджета и увеличение продаж. Идеально для <Link href="/landing-page" className="text-primary-300 hover:underline font-semibold">лендингов</Link>.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-white mb-1">1 день</div>
                  <p className="text-sm text-white/70">До запуска</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                ...
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-white mb-1">ROI 5:1</div>
                  <p className="text-sm text-white/70">Окупаемость</p>
                </div>
              </div>
            </div>
