...
export const metadata: Metadata = {
  ...
  description: 'Курсы программирования и создания сайтов в Алматы. Обучение веб-разработке с нуля, индивидуальный подход, опытные преподаватели. Начните карьеру в веб-разработке.',
