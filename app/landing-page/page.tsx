...
export const metadata: Metadata = {
  title: 'Landing Page в Алматы | Одностраничный сайт от 70 000 ₸',
  description: 'Профессиональная разработка Landing Page в Алматы. Продающие одностраничники с высокой конверсией для Google-рекламы. Современный дизайн, быстрая загрузка, SEO-оптимизация. Цена от 70 000 тенге.',
  keywords: [
    'landing page Алматы',
...
const faqItems = [
  {
    ...
    answer: 'Стоимость разработки Landing Page начинается от 70 000 тенге. Финальная цена зависит от сложности дизайна, количества блоков, интеграций и дополнительных функций. Мы предлагаем прозрачное ценообразование без скрытых платежей.',
  },
  {
    id: '2',
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8 animate-in">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-xl leading-relaxed">
                Создаём высококонверсионные Landing Page для вашего бизнеса. Идеальное решение для <Link href="/website-advertising" className="text-primary-300 hover:underline font-semibold">Google-рекламы</Link>, 
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  ...
                  <p className="text-sm text-white/70">Конверсия</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-white mb-1">3-5 дней</div>
                  <p className="text-sm text-white/70">Срок разработки</p>
                </div>
              </div>
            </div>
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-secondary-600">
              ...
              Больше работ в нашем <Link href="/portfolio" className="text-primary-600 hover:underline font-semibold">портфолио</Link>.
            </p>
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              <div className="text-5xl font-bold text-primary-600 mb-2">от 70 000 ₸</div>
      ...
      <section className="section bg-secondary-900 text-white">
        <div className="container-custom text-center">
          <h2 className="heading-lg mb-4">Готовы создать свой Landing Page?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href={`tel:${SITE_CONFIG.phone}`} className="btn-secondary">
              Позвонить
            </a>
          </div>
        </div>
