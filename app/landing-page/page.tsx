...
export const metadata: Metadata = {
  ...
  description: 'Профессиональная разработка Landing Page в Алматы. Продающие одностраничники с высокой конверсией для Google-рекламы. Современный дизайн, быстрая загрузка, SEO-оптимизация. Цена 85-95 тыс тенге.',
  keywords: [
    'landing page Алматы',
  ...
  openGraph: {
    title: 'Landing Page в Алматы | Одностраничный сайт 85-95 тыс ₸',
...
const faqItems = [
  {
    ...
    answer: 'Стоимость разработки Landing Page составляет 85-95 тыс тенге. Финальная цена зависит от сложности дизайна, количества блоков, интеграций и дополнительных функций. Мы предлагаем прозрачное ценообразование без скрытых платежей.',
  },
  {
    id: '2',
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8 animate-in">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-xl leading-relaxed">
                Создаём высококонверсионные Landing Page для вашего бизнеса. Идеальное решение для <Link href="/website-advertising" className="text-secondary-300 hover:underline font-semibold">Google-рекламы</Link>, 
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              <div className="text-5xl font-bold text-primary-600 mb-2">85-95 тыс ₸</div>
