...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-violet-50 via-white to-primary-50 dark:from-secondary-950 dark:via-secondary-900 dark:to-secondary-950 relative overflow-hidden">
