        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-left md:text-center">
              <div className="w-11 h-11 rounded-xl bg-secondary-700 text-secondary-300 flex items-center justify-center mx-auto mb-6">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="group min-h-[56px] inline-flex items-center justify-center gap-3 bg-white text-secondary-900 hover:bg-secondary-50 font-semibold px-8 py-4 rounded-xl transition-all duration-300 text-lg shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
              ...
              <Link
                href="/portfolio"
                className="group min-h-[56px] inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 text-lg border border-white/20 hover:border-white/30 hover:-translate-y-1"
              >
