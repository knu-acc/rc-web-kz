...
export default function ReviewsPage() {
  ...
  return (
    <>
      ...
      {/* Review Images Gallery with Carousel */}
      <ReviewsCarousel
        reviews={placeholderReviewImages}
        title="Реальные отзывы клиентов"
        subtitle="Скриншоты отзывов из мессенджеров и социальных сетей от наших довольных клиентов"
        showAllButton={false}
        showFilter={true}
      />
      ...
      <section className="section bg-gradient-to-br from-primary-600 to-primary-700 text-white">
        <div className="container-custom text-center pb-4">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <a href={SOCIAL_LINKS.whatsapp} className="min-h-[52px] inline-flex items-center justify-center gap-2 bg-white text-primary-600 hover:bg-primary-50 font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600">
            ...
            <Link href="/portfolio" className="min-h-[52px] inline-flex items-center justify-center bg-white/20 hover:bg-white/30 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-lg focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-primary-600">
