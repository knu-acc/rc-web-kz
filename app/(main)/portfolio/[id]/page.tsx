          ...
          <div className="container-custom max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                {project.caseStudy && (
                  <div className="space-y-6 mt-8">
                    {project.caseStudy.challenge && (
                      <div>
                        <h3 className="text-lg font-semibold mb-2 text-secondary-900 dark:text-white flex items-center gap-2">
                          <span className="w-2 h-2 rounded-full bg-red-500"></span>
                          Задача
                        </h3>
                        <p className="text-secondary-600 dark:text-secondary-300">{project.caseStudy.challenge}</p>
                      </div>
                    )}
                    {project.caseStudy.solution && (
                      <div>
                        ...
                        <p className="text-secondary-600 dark:text-secondary-300">{project.caseStudy.solution}</p>
                      </div>
                    )}
              ...
              <div>
                ...
                <dl className="space-y-4">
                  ...
                  {project.year && (
                    <div>
                      ...
                      <dd className="text-lg text-secondary-900 dark:text-white">{project.year}</dd>
                    </div>
                  )}
                  {project.duration && (
                    <div>
                      ...
                      <dd className="text-lg text-secondary-900 dark:text-white">{project.duration}</dd>
                    </div>
                  )}
                  {project.client && (
                    <div>
                      ...
                      <dd className="text-lg text-secondary-900 dark:text-white">{project.client}</dd>
                    </div>
                  )}
                  <div>
                    <dt className="text-sm font-medium text-secondary-500 dark:text-secondary-400">
                ...
                {project.caseStudy?.metrics && project.caseStudy.metrics.length > 0 && (
                  <div className="mt-8 p-6 bg-gradient-to-br from-primary-50 to-violet-50 dark:from-primary-900/20 dark:to-violet-900/20 rounded-xl">
                    ...
                    <ul className="space-y-2">
                      {project.features.map((feature, idx) => (
                        <li key={idx} className="flex items-start gap-2 text-secondary-600 dark:text-secondary-300">
                          <svg className="w-5 h-5 text-primary-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="text-left md:text-center bg-gradient-to-r from-primary-600 to-violet-600 rounded-2xl p-8 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/contact" prefetch className="btn-outline bg-white/10 border-white/20 text-white hover:bg-white/20">
                  Оставить заявку
                </Link>
              </div>
            </div>
