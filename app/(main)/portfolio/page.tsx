            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:gap-5">
                <a
                  ...
                  className="inline-flex min-h-[52px] items-center justify-center gap-2 rounded-xl bg-[#25D366] px-8 py-4 font-semibold text-white shadow-md hover:bg-[#1da851] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 dark:focus:ring-offset-secondary-950"
                >
                ...
                <a
                  ...
                  className="inline-flex min-h-[52px] items-center justify-center gap-2 rounded-xl border-2 border-secondary-300 dark:border-secondary-600 bg-white px-8 py-4 font-semibold text-secondary-800 dark:text-white hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-secondary-800 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-secondary-950"
                >
                  Позвонить
                </a>
              </div>
