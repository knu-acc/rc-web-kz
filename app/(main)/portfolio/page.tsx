      ...
      <div className="min-h-screen bg-white dark:bg-secondary-950">
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-5 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-[#1da851] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 dark:focus:ring-offset-secondary-950"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-lg border border-secondary-300 dark:border-secondary-600 bg-white dark:bg-secondary-800 px-5 py-2.5 text-sm font-medium text-secondary-800 dark:text-white hover:border-secondary-400 dark:hover:bg-secondary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-secondary-950"
                >
                  Позвонить
                </a>
              </div>
        ...
        <section className="border-t border-secondary-200 dark:border-secondary-800 bg-secondary-800 dark:bg-secondary-900 text-white">
          <div className="container-custom py-10 lg:py-12">
            ...
            <p className="mt-3 max-w-xl text-white/90 text-sm">
              Более 120 сайтов с 2020 года. Обсудим задачу и подготовим КП. Работаем по Алматы и всему Казахстану.
            </p>
            <div className="mt-6 flex flex-wrap gap-4">
              <a
                href={SOCIAL_LINKS.whatsapp}
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-medium text-secondary-900 shadow hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-secondary-800"
              >
              ...
              <a
                href={`tel:${SITE_CONFIG.phone}`}
                className="inline-flex items-center justify-center rounded-lg border border-white/60 px-5 py-2.5 text-sm font-medium hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-secondary-800"
              >
                {SITE_CONFIG.phone}
              </a>
            </div>
