...
export const metadata: Metadata = {
  ...
  description: 'Создание сайтов для компаний и бизнеса в Алматы. Корпоративные сайты, сайты-визитки, бизнес-сайты. Современный дизайн, полный функционал, техническая поддержка.',
