...
import { generateContactPageSchema, generateBreadcrumbSchema, generateLocalBusinessSchema } from '@/lib/schema'
import { YandexMap } from '@/components/sections/YandexMap'

export const metadata: Metadata = {
  title: 'Контакты',
  description: 'Свяжитесь со мной для заказа создания сайта в Алматы. WhatsApp, Telegram, телефон, email. Бесплатная консультация.',
  keywords: [
...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-violet-50 via-white to-primary-50 relative overflow-hidden">
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
            {contactMethods.map((method) => (
              <a
                key={method.id}
                href={method.href}
                className="group flex items-center gap-5 p-5 bg-white rounded-2xl border border-secondary-100 hover:border-transparent hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <div className="flex-grow min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <h3 className="font-bold text-secondary-900">{method.title}</h3>
                  ...
                  <p className="text-secondary-500 text-sm">{method.description}</p>
      ...
      <section className="section bg-secondary-50/50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-600 mt-4">Работаю удалённо по всему Казахстану</p>
          </div>
