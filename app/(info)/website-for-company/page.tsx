        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {siteTypes.map((type, index) => (
              <div key={index} className="group relative overflow-hidden rounded-2xl bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-700 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
