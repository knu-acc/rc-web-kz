...
const values = [
  ...
  },
  {
    ...
    description: 'Мы не бросаем клиентов после запуска. Мелкие правки  бесплатно. Техподдержка  всегда на связи.',
        ...
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { href: '/guarantees', title: 'Гарантии', desc: 'Что мы гарантируем' },
