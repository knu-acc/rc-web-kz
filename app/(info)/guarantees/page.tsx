...
const guarantees = [
  {
    ...
    description: 'В течение года бесплатно исправляем любые ошибки и баги в работе сайта: вёрстка, функционал, формы обратной связи.',
  ...
  },
  {
    ...
    description: 'Сроки фиксируются в договоре. Если задержка по нашей вине — предоставляем скидку 10% за каждую неделю просрочки.',
  ...
  },
  {
    ...
    description: 'После оплаты передаём исходные коды проекта, доступы к хостингу, домену, аналитике. Вы — владелец всего.',
...
const faq = [
  ...
  },
  {
    ...
    a: 'Изменение текстов, замена изображений, корректировка цветов, перемещение блоков. Всё в рамках утверждённого ТЗ. Добавление нового функционала — за отдельную плату.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да. Предлагаем пакеты техподдержки: от 15 000₸/мес за базовую поддержку до 45 000₸/мес за расширенную с SEO-продвижением.',
  },
]
