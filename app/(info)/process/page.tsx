...
const steps = [
  {
    ...
    duration: '12 дня',
    description: 'Собираем полную информацию о проекте: цели, целевую аудиторию, конкурентов, функциональные требования.',
    details: [
      'Заполняем бриф: 20+ вопросов о вашем бизнесе и ожиданиях',
      'Анализируем 35 сайтов конкурентов в вашей нише',
  ...
  },
  {
    ...
    duration: '12 дня',
    description: 'Создаём wireframe  схематичную структуру каждой страницы, без дизайна, но с логикой расположения блоков.',
    details: [
  ...
  },
  {
    ...
    tip: 'Мы предоставляем до 3 раундов правок  обычно дизайн согласовывается за 12 итерации.',
  ...
  },
  {
    ...
    tip: 'Мы показываем сайт на тестовом домене  можете проверить на любом устройстве.',
  ...
  },
  {
    ...
    tip: 'На этом этапе вы тестируете сайт сами и присылаете список замечаний  мы всё исправляем.',
  ...
  },
  {
    ...
    details: [
      ...
      'Проводим обучение по редактированию контента (3060 минут)',
    ],
    ...
    tip: 'После запуска мы 30 дней бесплатно вносим правки и помогаем с контентом.',
...
const faq = [
  {
    ...
    a: 'Landing page  от 5 дней, корпоративный сайт  710 дней, интернет-магазин  1015 дней. Точный срок зависит от сложности проекта и скорости согласования.',
  },
  {
    q: 'Можно ли вносить правки в процессе?',
    a: 'Да. На каждом этапе мы показываем результат и согласовываем. Правки вносятся бесплатно в рамках ТЗ. Дополнительные пожелания обсуждаются отдельно.',
  },
  {
    q: 'Нужно ли мне предоставлять тексты и фото?',
    a: 'Желательно. Если у вас нет контента, мы поможем подготовить тексты и подберём качественные стоковые изображения за дополнительную плату.',
  },
  {
    q: 'Что если мне не понравится дизайн?',
    a: 'Мы предоставляем до 3 раундов правок на этапе дизайна. Перед разработкой макет обязательно согласовывается. Мы не начинаем верстку без вашего одобрения.',
  },
  {
    q: 'Какой аванс вы берёте?',
    a: 'Обычно 50% аванс перед началом работы и 50% после запуска. Для крупных проектов возможна оплата в 3 этапа.',
  },
]
