...
const priceFactors = [
  {
    ...
    description: 'Каждая дополнительная страница  это дизайн, вёрстка и контент. 1 страница  +1015 тыс .',
    icon: (
  ...
  },
  {
    ...
    description: 'Срочные проекты (до 3 дней) могут стоить на 3050% дороже стандартного тарифа.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faq = [
  ...
  },
  {
    ...
    a: 'Нет. Стоимость фиксируется в договоре до начала работы. Все доп. работы согласовываются отдельно и оплачиваются только с вашего согласия.',
  },
  {
    q: 'Как происходит оплата?',
    a: 'Стандартная схема: 50% аванс перед началом, 50% после запуска сайта. Для крупных проектов возможна оплата в 3 этапа. Принимаем переводы на карту Kaspi и расчётный счёт.',
  },
  {
    q: 'Что дешевле: Next.js или Tilda?',
    a: 'Tilda обычно дешевле при простых проектах (13 страницы). Но для сложных задач (SEO, скорость, кастомный функционал) Next.js выгоднее долгосрочно.',
  },
  {
      ...
      <section className="relative overflow-hidden pt-24 pb-16">
        ...
        <div className="container-custom text-left md:text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-white/80 leading-relaxed mb-8">
            Все цены включают дизайн, разработку, SEO-оптимизацию и 30 дней поддержки.
            Без скрытых платежей  стоимость фиксируется в договоре.
          </p>
