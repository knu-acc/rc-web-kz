...
const faq = [
  ...
  },
  {
    ...
    a: 'Нет. Стоимость фиксируется в договоре до начала работы. Дополнительные работы согласовываются отдельно и оплачиваются только с вашего согласия.',
  },
  {
      ...
      <section className="relative overflow-hidden pt-24 pb-16">
        ...
        <div className="container-custom text-left md:text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-white/80 leading-relaxed mb-8">
            Все цены включают дизайн, разработку, SEO-оптимизацию и 30 дней поддержки. Без скрытых платежей — стоимость фиксируется в договоре.
          </p>
