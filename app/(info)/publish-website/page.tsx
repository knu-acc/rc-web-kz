...
const steps = [
  {
    ...
    description: 'Домен — это адрес сайта в интернете (например, vashsite.kz). Зарегистрируйте его на своё имя через официального регистратора.',
    details: [
      'Для зоны .kz используйте ps.kz или nic.kz — от 2 500₸/год',
      'Для .com — namecheap.com или reg.ru — от 5 000₸/год',
  ...
  },
  {
    ...
    details: [
      ...
      'WordPress — хостинг от 1 500₸/мес (ps.kz, hoster.kz)',
      'Интернет-магазин — VPS от 3 000₸/мес или облако (DigitalOcean, Timeweb)',
    ],
    warning: null,
    duration: '1 час',
  },
        ...
        <div className="container-custom max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'Можно ли опубликовать бесплатно?', a: 'Да. Netlify, Vercel, GitHub Pages — бесплатный хостинг для статических сайтов. Нужно только купить домен (от 2 500₸/год).' },
            ].map(faq => (
