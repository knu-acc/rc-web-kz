...
export const metadata: Metadata = {
  title: 'Сайт на Tilda в Алматы | Создание сайта на Тильде от 160 тыс ₸ | RC-WEB',
  ...
  openGraph: {
    title: 'Сайт на Tilda в Алматы | Создание сайта на Тильде от 160 тыс ₸',
...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Стоимость разработки сайта на Tilda начинается от 160 тыс тенге. Цена зависит от количества страниц, сложности дизайна и дополнительного функционала. В стоимость входит настройка всех блоков, адаптация под мобильные и базовая SEO-оптимизация.',
  },
  {
    id: '3',
            ...
            <div className="space-y-8 animate-in">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                ...
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  ...
                  <p className="text-sm text-white/70">Блоков</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-white mb-1">Сами</div>
                  <p className="text-sm text-white/70">Редактируете</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-primary-600 text-white rounded-2xl p-4 shadow-lg">
                <div className="text-2xl font-bold">160 тыс ₸</div>
            ...
            <div className="rounded-3xl bg-secondary-800 p-8 border border-secondary-700">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-white/80">Стоимость от 160 тыс ₸</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
            ...
            <div className="rounded-3xl bg-secondary-800 p-8 border border-secondary-700">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-white/80">Стоимость от 100 000 ₸</span>
                </li>
              </ul>
              <div className="mt-8">
                <span className="text-sm text-white/60">Идеально для:</span>
