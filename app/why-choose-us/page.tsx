...
export const metadata: Metadata = {
  ...
  description: 'Почему выбирают RC-WEB для создания сайтов в Алматы: качество разработки, поддержка клиентов, комплексная услуга, доступные цены. Более 120 довольных клиентов.',
